...
<?php
    ...
    if($condition == "제목"){
            $sql = "select * from book_report where subject like '%$keyword%' and id='$userid' order by num desc";
    }elseif($condition == "장르"){
            $sql = "select * from book_report where genre like '%$keyword%' and id='$userid' order by num desc";
    }elseif($condition == "지은이"){
            $sql = "select * from book_report where author like '%$keyword%' and id='$userid' order by num desc";
    }else{
            $sql = "select * from book_report where publisher like '%$keyword%' and id='$userid' order by num desc";
    }
